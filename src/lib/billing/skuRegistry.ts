...
export const SKU_REGISTRY: Sku[] = [
  ...
  {
    id: 'tool_ig_post_intelligence',
    type: 'tool',
    title: 'IG Post Intelligence',
    subtitle: 'Upgrade posts with AI insights.',
    priceDisplay: '$39',
    toolId: 'ig-post-intelligence',
    ctaLabel: 'Buy tool',
    entitlements: { tools: ['ig-post-intelligence'] },
    trial: { enabled: true, oneTimePerTool: true, mode: 'preview' },
  },
  {
    id: 'tool_yt_video_intelligence',
    type: 'tool',
    title: 'YT Video Intelligence',
    subtitle: 'Optimize YouTube scripts and hooks.',
    priceDisplay: '$39',
    toolId: 'yt-video-intelligence',
    ctaLabel: 'Buy tool',
    entitlements: { tools: ['yt-video-intelligence'] },
    trial: { enabled: true, oneTimePerTool: true, mode: 'preview' },
  },
  {
  ...
  },
  {
    ...
    priceDisplay: '$199',
    ctaLabel: 'Get stack',
    entitlements: { tools: ['hook-analyzer', 'ig-post-intelligence'] },
  },
  {
