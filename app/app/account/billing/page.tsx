...
export default async function BillingPage() {
  ...
  return (
    <section className="space-y-4">
      ...
      <div className="rounded-2xl border border-white/10 bg-[#3a3a3a] p-4 space-y-3 text-[hsl(var(--text))] shadow-[0_24px_40px_rgba(0,0,0,0.35)]">
      ...
      <div className="rounded-2xl border border-white/10 bg-[#3a3a3a] p-4 space-y-3 text-[hsl(var(--text))] shadow-[0_24px_40px_rgba(0,0,0,0.35)]">
        <div>
          ...
          <p className="text-xs text-[hsl(var(--muted))]">Track daily usage and buy more when needed.</p>
        </div>
        <div className="grid gap-2 text-xs text-[hsl(var(--muted))]">
