  ...
  return (
    <div className="min-h-screen bg-[#5f7f57] text-[hsl(var(--text))]">
      <div className="mx-auto max-w-3xl space-y-6 px-6 py-10">
        <div>
          <h1 className="text-2xl font-semibold text-[#1f3b2b]">Help</h1>
          <p className="text-sm text-[#1f3b2b]">Quick guidance for starting your trial and upgrading.</p>
        </div>

        <Card className="space-y-4">
          <div>
            <h2 className="text-sm font-semibold text-[#1f3b2b]">Start your 7-day trial</h2>
            <ol className="mt-2 list-decimal space-y-2 pl-5 text-sm text-[#1f3b2b]">
          ...
          <div>
            <h2 className="text-sm font-semibold text-[#1f3b2b]">Pro vs Elite</h2>
            <ul className="mt-2 list-disc space-y-2 pl-5 text-sm text-[#1f3b2b]">
            ...
            <p className="mt-2 text-sm text-[#1f3b2b]">
        ...
        <div>
          <h2 className="text-xl font-semibold text-[#1f3b2b]">Billing help</h2>
          <p className="text-sm text-[#1f3b2b]">Clear answers to common billing questions.</p>
        </div>

        <Card className="space-y-4">
          <div>
            <h2 className="text-sm font-semibold text-[#1f3b2b]">Why am I locked?</h2>
          ...
          <div>
            <h2 className="text-sm font-semibold text-[#1f3b2b]">When do tokens reset?</h2>
            <p className="text-sm text-[#1f3b2b]">
              Tokens reset daily at a consistent local time. Your Usage page shows the exact reset time.
            </p>
          </div>
          <div>
            <h2 className="text-sm font-semibold text-[#1f3b2b]">How do token packs work?</h2>
            <p className="text-sm text-[#1f3b2b]">
          ...
          <div>
            <h2 className="text-sm font-semibold text-[#1f3b2b]">How do I manage or cancel my plan?</h2>
            <p className="text-sm text-[#1f3b2b]">
              Use the Manage plan button to open the billing portal and update or cancel anytime.
            </p>
          </div>
          <div>
            <h2 className="text-sm font-semibold text-[#1f3b2b]">Refunds</h2>
            <p className="text-sm text-[#1f3b2b]">
